...
import 'package:flutter_rps_game/game/widget/cpu_input.dart';
import 'package:flutter_rps_game/game/widget/game_result.dart';
import 'package:flutter_rps_game/game/widget/user_input.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(child: GameResult(isDone: isDone, result: _getResult())),
        Expanded(child: UserInput(userInput: _userInput, isDone: isDone, callback: setUserInput)),
      ],
    );
  }
