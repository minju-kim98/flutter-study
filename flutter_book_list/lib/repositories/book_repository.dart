...
class BookRepository{
  final List<Book> _dummyBooks = [
    ...
    Book(
      ...
      description: '많은 개발 언어 중에서 직관적이고 배우기 쉬운 Vue.js를 다뤘다. 『Vue.js 프로젝트 투입 일주일 전』은 실무에서 프로젝트를 개발하는 진행 순서에 맞춰서 구성했기 때문에 초보자도 충분히 따라할 수 있으며, 개발 기초 지식이 있는 독자라면 조금 더 빠르게 Vue.js를 배울 수 있다. 개발 환경 설정부터 웹 앱 구현까지 책을 따라 하면서 자연스럽게 실무에 필요한 내용을 배워 보자.',
